...
import (
	...
	"github.com/ADAIN/go-ethereum-genesis-test/internal/build"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ADAIN/go-ethereum-genesis-test/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/ADAIN/go-ethereum-genesis-test/mobile")
